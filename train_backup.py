...
parser.add_argument('--kabur', default=False, action='store_true')
...
if __name__ == '__main__':
    ...
    if args.kabur:
        ...
        with open("temp_train_man.csv", "w+") as file:
            file.write(train_man_content.replace("tomas", "kabur"))

        with open(args.val_manifest, "r") as file:
            val_man_content = file.read()
        with open("temp_val_man.csv", "w+") as file:
            file.write(val_man_content.replace("tomas", "kabur"))
